...
@section('content')
    ...
    <main class="grow w-full max-w-full mx-auto px-4 pb-6 pt-20" x-data="{ open: false, modalImage: '' }">

        <header class="relative w-full px-4 h-[85vh] rounded-[40px] overflow-hidden group cursor-pointer"
            ...
            <div
                class="absolute top-1/2 right-1 lg:right-20 -translate-y-1/2 text-right z-20 transition-opacity duration-500 group-hover:opacity-0">
                <div
                    class="inline-block bg-[--primary-color] backdrop-blur-md
                    rounded-3xl rounded-b-[6rem] text-center
                    px-8 py-10 shadow-2xl">

                    <h1 class="text-5xl lg:text-6xl font-bold text-[--text-color] drop-shadow-lg">
                        Welcome to the Sanctuary
                    </h1>

                    <h2 class="mt-3 text-xl lg:text-2xl text-[--text-color] font-light leading-relaxed drop-shadow-md">
                        For Second Chances
                    </h2>
                </div>
            </div>
        ...
        <section class="relative bg-[--text-color] py-16 mt-5 rounded-2xl overflow-hidden">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <img src="{{ asset('assets/images/elements/heart-hand.svg') }}" alt="Heart and Hands"
                    class="mx-auto mb-3 w-32 h-38">

                <p class="text-[--bg-color] text-xl sm:text-2xl lg:text-3xl leading-relaxed font-light">
            ...
            <!-- THIN bottom border -->
            <img src="{{ asset('assets/images/elements/border-line.svg') }}" alt=""
                class="absolute max-w-full bottom-0 left-0 w-full h-3 object-cover">
        </section>
        ...
        <section class="-mx-4 py-16">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <div class="overflow-hidden mb-1 flex justify-center">
                        <img src="{{ asset('assets/images/elements/divider.svg') }}" alt="Addiction Center Banner"
        ...
        <section class="py-16 px-4 sm:px-6 lg:px-8" x-data="updatesComponent()">
            <h2 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[--text-color] text-center">
            ...
            <div class="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                <template x-for="(update, index) in updates" :key="index">
                    <div
                        class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 p-6 flex flex-col justify-between">

                        <!-- Date -->
                        <div class="text-sm text-gray-400 mb-2" x-text="update.date"></div>

                        <!-- Title -->
                        <h3 class="cardo text-xl font-semibold mb-2 text-[--text-color]" x-text="update.title">
                        </h3>

                        <!-- Short Description -->
                        <p class="hind mb-4" x-text="update.shortDesc"></p>
                        ...
                        <!-- See More Button -->
                        <button
                            class="self-start bg-[var(--accent-color)] text-white px-5 py-2 rounded-xl font-semibold text-sm hover:bg-[var(--primary-color)] transition-colors duration-300"
                            @click="openModal(index)">
                            See More
                        </button>
                    </div>
            ...
            return {
                ...
                updates: [{
                    ...
                    },
                    {
                        ...
                        images: ["assets/images/posts/info-1.jpg", "assets/images/posts/info-2.jpg",
                            "assets/images/posts/info-3.jpg", "assets/images/posts/info-4.jpg",
                            "assets/images/posts/info-5.jpg", "assets/images/posts/info-6.jpg",
                        ],
                        socialLinks: {
                            facebook: "https://www.facebook.com/sanctuaryforsecondchances",
