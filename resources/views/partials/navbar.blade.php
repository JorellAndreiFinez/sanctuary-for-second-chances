<nav x-data="{
        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <a href="/" class="flex items-center space-x-3">
                <img class="h-12 w-auto rounded-xl" src="{{ asset('assets/images/logo-transparent.png') }}"
                    alt="Sanctuary Logo">
                <span class="text-sm lg:hidden sm:block font-bold text-[--text-color] uppercase">The Sanctuary for Second Chances</span>
            </a>
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" x-transition
                        ...
                        <a href="{{ route('about.sanctuary') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">Sanctuary for
                            Second Chances</a>
                        <a href="{{ route('about.mission') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">Mission,
                            Vision & Core Values</a>
                        <a href="{{ route('about.history') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">History</a>
                        <a href="{{ route('about.board-of-trustees') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">Board of
                            Trustees</a>
                        <a href="{{ route('about.sdg') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">Sustainable
                            Development Goals</a>
                    </div>
                </div>

                <a href="{{ route('get-help') }}"
                    class="text-white font-normal hover:text-secondary-color transition">Get Help</a>

                <!-- Programs & Services Dropdown -->
                <div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" class="relative">
                    <button class="text-white font-normal hover:text-secondary-color transition flex items-center gap-1"
                    ...
                    <div x-show="open" x-transition.origin.top.left x-cloak
                        class="absolute left-0 mt-3 w-60 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50">
    ...
    <!-- Mobile Menu -->
    <div x-show="mobileOpen" x-transition class="lg:hidden bg-primary-color text-white w-full px-4 py-2 space-y-1"
        x-cloak>
        ...
        <div x-data="{ open: false }" class="space-y-1">
            ...
            <div x-show="open" x-transition class="pl-4 space-y-1" x-cloak>
                <a href="{{ route('about.sanctuary') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Sanctuary for Second Chances</a>
                <a href="{{ route('about.mission') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Mission, Vision & Core Values</a>
                <a href="{{ route('about.history') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">History</a>
                <a href="{{ route('about.board-of-trustees') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Board of Trustees</a>
                <a href="{{ route('about.sdg') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Sustainable Development Goals</a>
            </div>
        </div>
        ...
        <div x-data="{ open: false }" class="space-y-1">
            ...
            <div x-show="open" x-transition class="pl-4 space-y-1" x-cloak>
                <a href="{{ route('programs.residential') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Residential</a>
                <a href="{{ route('programs.family-support') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Family Support</a>
                <a href="{{ route('programs.non-residential') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Non-Residential</a>
                <a href="{{ route('programs.recovery-coaching-training') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Recovery Coaching Training</a>
                <a href="{{ route('programs.psychoeducational-awareness') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Psychoeducational Awareness</a>
                <a href="{{ route('programs.disease-of-addiction') }}"
                    class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Disease of Addiction</a>
            </div>
        </div>
        ...
        <a href="{{ route('contact-us') }}" class="block px-4 py-2 hover:bg-secondary-color rounded-lg">Contact
            Us</a>
    </div>
</nav>
